package com.roosterpark.rptime.selenium.page.admin.contracts;
 ...
 * Time: 9:42 AM
 */
public class ClientFilterSelect extends DropDownList {
    ...
    public ClientFilterSelect(WebDriver driver) {
        super(driver, ID);
